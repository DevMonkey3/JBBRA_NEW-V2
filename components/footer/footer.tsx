...
import { getOptimizedImageProps, preloadCriticalImages } from "@/lib/image-optimizer";
...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="footer-custom">
      {/* Static image banner grid - replaced animated carousel for better performance */}
      <div className="relative w-full py-12 bg-gradient-to-r from-blue-50 to-blue-100">
        <div className="max-w-7xl mx-auto px-4">
          {/* Image grid - 3 columns on mobile, 6 on desktop */}
              ...
              <div key={i} className="aspect-video">
                <Image
                  {...getOptimizedImageProps(
                    ...
                    320,
                    180,
                    true // Enable lazy loading for footer images
                  )}
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4 z-10">
          <p className="text-blue-600 text-base md:text-lg mb-2 opacity-90 font-semibold">
            Features
          </p>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 mt-2">
            <Link href="/download">
              <Button
                shape="round"
                size="large"
                className="btn-primary text-white hover:bg-blue-700"
              >
                Download Resources
              </Button>
            </Link>
            <Link href="/jbbc/contact/inquiry">
              <Button
                shape="round"
                size="large"
                className="btn-secondary hover:bg-blue-600 hover:text-white"
              >
                Contact Us
              </Button>
            </Link>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6 bg-white rounded-xl px-8 py-8 shadow-lg border-l-4 border-blue-600">
            ...
            <div className="flex flex-col gap-2 text-left">
              ...
              <p className="text-sm text-gray-600 m-0">
                Always check Jbbra's latest recruitment information
              </p>
            </div>
